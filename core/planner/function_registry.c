...
static const RxFunctionSignature k_default_functions[] = {
    ...
    { "synthetic_records", RX_CALL_SOURCE, 1, 1, RX_ARG_OBSERVABLE_PTR,
      { RX_ARG_INT, RX_ARG_NONE, RX_ARG_NONE, RX_ARG_NONE },
      false, true, false, false, false, RX_SEGMENT_RULE_FLEXIBLE },
    { "external_buffer", RX_CALL_SOURCE, 0, 0, RX_ARG_OBSERVABLE_PTR,
      { RX_ARG_NONE, RX_ARG_NONE, RX_ARG_NONE, RX_ARG_NONE },
      false, true, false, false, false, RX_SEGMENT_RULE_FLEXIBLE },
    { "external_window", RX_CALL_SOURCE, 1, 1, RX_ARG_OBSERVABLE_PTR,
      { RX_ARG_INT, RX_ARG_NONE, RX_ARG_NONE, RX_ARG_NONE },
      false, true, false, false, false, RX_SEGMENT_RULE_FLEXIBLE },
    ...
    { "map", RX_CALL_OPERATOR, 1, 1, RX_ARG_QUERY_PTR,
      ...
      false, true, false, false, false, RX_SEGMENT_RULE_FLEXIBLE },
    { "mapInto", RX_CALL_OPERATOR, 2, 2, RX_ARG_QUERY_PTR,
      { RX_ARG_MODIFIER_FN, RX_ARG_VOID_PTR, RX_ARG_NONE, RX_ARG_NONE },
      false, true, false, false, false, RX_SEGMENT_RULE_FLEXIBLE },
